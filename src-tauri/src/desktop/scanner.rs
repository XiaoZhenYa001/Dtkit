...
impl FileCategory {
    ...
    pub fn from_extension(ext: &str, is_dir: bool) -> Self {
        ...
        match ext.as_str() {
            ...
            "csv" | "json" | "xml" | "html" | "htm" => FileCategory::Document,
            
            // 图片
            "jpg" | "jpeg" | "png" | "gif" | "bmp" | "svg" | "webp" |
            "ico" | "tiff" | "tif" | "psd" | "raw" | "heic" | "heif" => FileCategory::Image,
            
            // 视频
            "mp4" | "avi" | "mkv" | "mov" | "wmv" | "flv" | "webm" |
            "m4v" | "mpeg" | "mpg" | "3gp" | "ts" => FileCategory::Video,
            
            // 音频
            "mp3" | "wav" | "flac" | "aac" | "ogg" | "wma" | "m4a" |
            "ape" | "alac" | "aiff" => FileCategory::Audio,
            
            // 压缩包
            "zip" | "rar" | "7z" | "tar" | "gz" | "bz2" | "xz" |
            "iso" | "dmg" | "cab" => FileCategory::Archive,
            
            // 程序
            "exe" | "msi" | "bat" | "cmd" | "ps1" | "sh" |
            "app" | "deb" | "rpm" | "lnk" => FileCategory::Program,
...
/// 搜索桌面文件
pub fn search_desktop_files(query: &str, category_filter: Option<&str>) -> Result<Vec<DesktopFile>, String> {
    let desktop_path = get_desktop_path()
        .ok_or_else(|| "无法获取桌面路径".to_string())?;
